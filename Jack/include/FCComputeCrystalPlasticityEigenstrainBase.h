...
/**
 * FCComputeCrystalPlasticityEigenstrainBase is the base class for computing eigenstrain tensors in
 * crystal plasticity models
 */
class FCComputeCrystalPlasticityEigenstrainBase : public ComputeEigenstrainBase
{
public:
  static InputParameters validParams();

  FCComputeCrystalPlasticityEigenstrainBase(const InputParameters & parameters);
